...
import 'package:space_quiz_bank/data/category_data.dart';
...
import 'package:space_quiz_bank/widgets/category_grid_item.dart';
          ...
          children: [
            for (final category in availableCategories)
              CategoryGridItem(
                category: category,
                onSelectCategory: () {
                  final firebaseLessonList = ref.watch(filteredLessonProvider);
                  final filteredLesson = firebaseLessonList
                      .where(
                          (lesson) => lesson.categories.contains(category.id))
                      .toList();
